ROOMS = {
    ...
    "garden": {
        "description": "Тайный сад внутри лабиринта. Цветы светятся в темноте, слышно журчание ручья.",
        "exits": {"west": "armory", "north": "dungeon"},
        "items": ["magic herb"],
        "puzzle": ('Среди цветов записка: "Назовите месяц, в котором 28 дней".', "все"),
    },
    "dungeon": {
        "description": "Сырая и холодная темница. На стенах цепи, в углу лежит старый сундук.",
        "exits": {"south": "garden"},
        "items": ["iron key", "shield"],
        "puzzle": (
            'На двери гравировка: "Что тяжелее — килограмм ваты или килограмм железа?"',
            "равны",
        ),
    },
}
